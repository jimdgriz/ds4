...
tests/cuda_long_context_smoke: tests/cuda_long_context_smoke.o ds4_cuda.o ds4_ssd.o
...
tests/test_gpu_xdev: tests/test_gpu_xdev.o ds4_cuda.o ds4_ssd.o
...
tests/test_gpu_model_cache: tests/test_gpu_model_cache.o ds4_cuda.o ds4_ssd.o
...
tests/test_gpu_lookup_cache_strict: tests/test_gpu_lookup_cache_strict.o ds4_cuda.o ds4_ssd.o
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)

tests/test_cuda_host_expert_cache.o: tests/test_cuda_host_expert_cache.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -I$(CUDA_HOME)/include -c -o $@ $<

tests/test_cuda_host_expert_cache: tests/test_cuda_host_expert_cache.o ds4_cuda.o ds4_ssd.o
